...
class PostgraduateModel : public QAbstractTableModel
{
    Q_OBJECT
public:
    explicit PostgraduateModel(QVector<CONST::HDG> indexMap, QObject *parent = 0);
    ~PostgraduateModel();
...
private:
    QList<Postgraduate> _list = QList<Postgraduate>();
    QList<Postgraduate> _listOriginal = _list;
...
inline void PostgraduateModel::setEnableFilter(bool enable)
{
...
inline void PostgraduateModel::setFilterColumn(const CONST::HDG column)
{
...
inline void PostgraduateModel::setFilterString(const QString &newString)
{
...
inline void PostgraduateModel::setFilterSex(const Person::Sex sex)
{
...
inline void PostgraduateModel::setFilterCaseSentivity(bool sensitive)
{
...
inline void PostgraduateModel::setFilterUseRegexp(bool yes)
{
...
inline void PostgraduateModel::setFilterMinDate(const QDate &min)
{
...
inline void PostgraduateModel::setFilterMaxDate(const QDate &max)
{
