...
class TeachingAssistantModel : public QAbstractTableModel
{
    Q_OBJECT
public:
    explicit TeachingAssistantModel(QVector<CONST::HDG> indexMap, QObject *parent = 0);
...
private:
    QList<TeachingAssistant> _list = QList<TeachingAssistant>();
    QList<TeachingAssistant> _listOriginal = _list;
...
inline void TeachingAssistantModel::setEnableFilter(bool enable)
{
...
inline void TeachingAssistantModel::setFilterColumn(const CONST::HDG column)
{
...
inline void TeachingAssistantModel::setFilterString(const QString &newString)
{
...
inline void TeachingAssistantModel::setFilterSex(const Person::Sex sex)
{
...
inline void TeachingAssistantModel::setFilterCaseSentivity(bool sensitive)
{
...
inline void TeachingAssistantModel::setFilterUseRegexp(bool yes)
{
...
inline void TeachingAssistantModel::setFilterMinDate(const QDate &min)
{
...
inline void TeachingAssistantModel::setFilterMaxDate(const QDate &max)
{
