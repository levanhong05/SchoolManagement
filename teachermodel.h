...
class TeacherModel : public QAbstractTableModel
{
    Q_OBJECT
public:
    explicit TeacherModel(QVector<CONST::HDG> indexMap, QObject *parent = 0);
    ~TeacherModel();
...
private:
    QList<Teacher> _list = QList<Teacher>();
    QList<Teacher> _listOriginal = _list;
...
inline void TeacherModel::setEnableFilter(bool enable)
{
...
inline void TeacherModel::setFilterColumn(const CONST::HDG column)
{
...
inline void TeacherModel::setFilterString(const QString &newString)
{
...
inline void TeacherModel::setFilterSex(const Person::Sex sex)
{
...
inline void TeacherModel::setFilterCaseSentivity(bool sensitive)
{
...
inline void TeacherModel::setFilterUseRegexp(bool yes)
{
...
inline void TeacherModel::setFilterMinDate(const QDate &min)
{
...
inline void TeacherModel::setFilterMaxDate(const QDate &max)
{
